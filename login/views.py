...
def site(request):
	...
	if request.method == 'POST':
		...
		if company_str == 'Enigma Limited':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Enigma += amount/(company_name.price0)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Enigma - amount > error:
					user.profile.Enigma-=amount
					user.profile.money+=amount*(company_name.price0)
					user.profile.save()

		elif company_str == 'Tec Solutions':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Tec += amount/(company_name.price0)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.GAAP += amount/(company_name.price0)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.ALPHA += amount/(company_name.price0)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.LAXMI += amount/(company_name.price0)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
		...
		elif company_str == 'CREDIT INDIA':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Punjab += amount/(company_name.price0)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Lifepoint += amount/(company_name.price0)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.RIGHT += amount/(company_name.price0)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
...
def detail(request, id):
	...
	elif c_name == 'CREDIT INDIA':
		return render(request, 'login/Punjab.html', {'title': 'CREDIT INDIA'})
...
def round11(request):
	...
	all_company = company.objects.all()
	return render(request, 'login/round11.html', { 
			'user': user,
			'companys': all_company,
			'date': date,
			'tec0': (company.objects.get(pk=2)).price0,
			...
			'tec9': (company.objects.get(pk=2)).price9,
			'tec10': (company.objects.get(pk=2)).price10,
			'tec11': (company.objects.get(pk=2)).price11,
			'tec12': (company.objects.get(pk=2)).price12,
			'tec13': (company.objects.get(pk=2)).price13,
			'tec14': (company.objects.get(pk=2)).price14,
			'en0': (company.objects.get(pk=1)).price0,
			'en1': (company.objects.get(pk=1)).price1,
			'en2': (company.objects.get(pk=1)).price2,
			'en3': (company.objects.get(pk=1)).price3,
			...
			'en9': (company.objects.get(pk=1)).price9,
			'en10': (company.objects.get(pk=1)).price10,
			'en11': (company.objects.get(pk=1)).price11,
			'en12': (company.objects.get(pk=1)).price12,
			'en13': (company.objects.get(pk=1)).price13,
			'en14': (company.objects.get(pk=1)).price14,
			'gaa0': (company.objects.get(pk=3)).price0,
			'gaa1': (company.objects.get(pk=3)).price1,
			'gaa2': (company.objects.get(pk=3)).price2,
			'gaa3': (company.objects.get(pk=3)).price3,
			...
			'gaa9': (company.objects.get(pk=3)).price9,
			'gaa10': (company.objects.get(pk=3)).price10,
			'gaa11': (company.objects.get(pk=3)).price11,
			'gaa12': (company.objects.get(pk=3)).price12,
			'gaa13': (company.objects.get(pk=3)).price13,
			'gaa14': (company.objects.get(pk=3)).price14,
			'alp0': (company.objects.get(pk=4)).price0,
			'alp1': (company.objects.get(pk=4)).price1,
			'alp2': (company.objects.get(pk=4)).price2,
			'alp3': (company.objects.get(pk=4)).price3,
			...
			'alp9': (company.objects.get(pk=4)).price9,
			'alp10': (company.objects.get(pk=4)).price10,
			'alp11': (company.objects.get(pk=4)).price11,
			'alp12': (company.objects.get(pk=4)).price12,
			'alp13': (company.objects.get(pk=4)).price13,
			'alp14': (company.objects.get(pk=4)).price14,
			'lax0': (company.objects.get(pk=5)).price0,
			'lax1': (company.objects.get(pk=5)).price1,
			'lax2': (company.objects.get(pk=5)).price2,
			'lax3': (company.objects.get(pk=5)).price3,
			...
			'lax9': (company.objects.get(pk=5)).price9,
			'lax10': (company.objects.get(pk=5)).price10,
			'lax11': (company.objects.get(pk=5)).price11,
			'lax12': (company.objects.get(pk=5)).price12,
			'lax13': (company.objects.get(pk=5)).price13,
			'lax14': (company.objects.get(pk=5)).price14,
			'pnb0': (company.objects.get(pk=6)).price0,
			'pnb1': (company.objects.get(pk=6)).price1,
			'pnb2': (company.objects.get(pk=6)).price2,
			'pnb3': (company.objects.get(pk=6)).price3,
			...
			'pnb9': (company.objects.get(pk=6)).price9,
			'pnb10': (company.objects.get(pk=6)).price10,
			'pnb11': (company.objects.get(pk=6)).price11,
			'pnb12': (company.objects.get(pk=6)).price12,
			'pnb13': (company.objects.get(pk=6)).price13,
			'pnb14': (company.objects.get(pk=6)).price14,
			'lif0': (company.objects.get(pk=7)).price0,
			'lif1': (company.objects.get(pk=7)).price1,
			'lif2': (company.objects.get(pk=7)).price2,
			'lif3': (company.objects.get(pk=7)).price3,
			...
			'lif9': (company.objects.get(pk=7)).price9,
			'lif10': (company.objects.get(pk=7)).price10,
			'lif11': (company.objects.get(pk=7)).price11,
			'lif12': (company.objects.get(pk=7)).price12,
			'lif13': (company.objects.get(pk=7)).price13,
			'lif14': (company.objects.get(pk=7)).price14,
			'rig0': (company.objects.get(pk=8)).price0,
			'rig1': (company.objects.get(pk=8)).price1,
			'rig2': (company.objects.get(pk=8)).price2,
			'rig3': (company.objects.get(pk=8)).price3,
			...
			'rig9': (company.objects.get(pk=8)).price9,
			'rig10': (company.objects.get(pk=8)).price10,
			'rig11': (company.objects.get(pk=8)).price11,
			'rig12': (company.objects.get(pk=8)).price12,
			'rig13': (company.objects.get(pk=8)).price13,
			'rig14': (company.objects.get(pk=8)).price14,

		 })

@login_required
def round12(request):
	date = Date.objects.get(pk=13)
	user = request.user
	if request.method == 'POST':
		error = -0.000000001
		company_str = str(company.objects.get(pk=request.POST['company_id']))
		...
		if company_str == 'Enigma Limited':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Enigma += amount/(company_name.price11)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Enigma - amount > error:
					user.profile.Enigma-=amount
					user.profile.money+=amount*(company_name.price11)
					user.profile.save()

		elif company_str == 'Tec Solutions':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Tec += amount/(company_name.price11)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Tec - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.GAAP += amount/(company_name.price11)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.GAAP - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.ALPHA += amount/(company_name.price11)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.ALPHA - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.LAXMI += amount/(company_name.price11)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.LAXMI - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Punjab += amount/(company_name.price11)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Punjab - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Lifepoint += amount/(company_name.price11)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Lifepoint - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.RIGHT += amount/(company_name.price11)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.RIGHT - amount > error:
	...
	all_company = company.objects.all()
	return render(request, 'login/round12.html', { 
			'user': user,
			'companys': all_company,
			'date': date,
			'tec0': (company.objects.get(pk=2)).price0,
...
def round13(request):
	...
	if request.method == 'POST':
		...
		if company_str == 'Enigma Limited':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Enigma += amount/(company_name.price12)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Enigma - amount > error:
					user.profile.Enigma-=amount
					user.profile.money+=amount*(company_name.price12)
					user.profile.save()

		elif company_str == 'Tec Solutions':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Tec += amount/(company_name.price12)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Tec - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.GAAP += amount/(company_name.price12)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.GAAP - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.ALPHA += amount/(company_name.price12)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.ALPHA - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.LAXMI += amount/(company_name.price12)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.LAXMI - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Punjab += amount/(company_name.price12)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Punjab - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Lifepoint += amount/(company_name.price12)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Lifepoint - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.RIGHT += amount/(company_name.price12)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.RIGHT - amount > error:
	...
	all_company = company.objects.all()
	return render(request, 'login/round13.html', { 
			'user': user,
			'companys': all_company,
			'date': date,
			'tec0': (company.objects.get(pk=2)).price0,
...
def round14(request):
	...
	if request.method == 'POST':
		...
		if company_str == 'Enigma Limited':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Enigma += amount/(company_name.price13)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Enigma - amount > error:
					user.profile.Enigma-=amount
					user.profile.money+=amount*(company_name.price13)
					user.profile.save()

		elif company_str == 'Tec Solutions':
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Tec += amount/(company_name.price13)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Tec - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.GAAP += amount/(company_name.price13)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.GAAP - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.ALPHA += amount/(company_name.price13)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.ALPHA - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.LAXMI += amount/(company_name.price13)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.LAXMI - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Punjab += amount/(company_name.price13)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Punjab - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.Lifepoint += amount/(company_name.price13)
					user.profile.money -=  amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.Lifepoint - amount > error:
			...
			if opr == 'buy':
				if user.profile.money - amount > error:
					user.profile.RIGHT += amount/(company_name.price13)
					user.profile.money -= amount
					user.profile.save()
			elif opr == 'sell':
				if user.profile.RIGHT - amount > error:
	...
	all_company = company.objects.all()
	return render(request, 'login/round14.html', { 
			'user': user,
			'companys': all_company,
			'date': date,
			'tec0': (company.objects.get(pk=2)).price0,
...
def finish(request):
	...
	if request.method == 'POST':
		...
		user.profile.save()
		money = round(user.profile.money-1000000.0, 2)
	...
	user.profile.money+=user.profile.Enigma*comp.price14
	comp = company.objects.get(pk=2)
	user.profile.money+=user.profile.Tec*comp.price14
	comp = company.objects.get(pk=3)
	user.profile.money+=user.profile.GAAP*comp.price14
	comp = company.objects.get(pk=4)
	user.profile.money+=user.profile.ALPHA*comp.price14
	comp = company.objects.get(pk=5)
	user.profile.money+=user.profile.LAXMI*comp.price14
	comp = company.objects.get(pk=6)
	user.profile.money+=user.profile.Punjab*comp.price14
	comp = company.objects.get(pk=7)
	user.profile.money+=user.profile.Lifepoint*comp.price14
	comp = company.objects.get(pk=8)
	user.profile.money+=user.profile.RIGHT*comp.price14
	money = round(user.profile.money-1000000.0, 2)
